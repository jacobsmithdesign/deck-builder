...
export default function Details() {
  ...
  return (
    <section id="#overview">
      <Board className="rounded-none ease-in-out px-1 pb-1 h-full max-w-[85rem] mx-auto mt-14">
        <BoardContent className="transition-all duration-700 justify-center items-center relative rounded-t-none  h-full">
          <div className="w-full h-full hide-scrollbar absolute px-2 ">
            <div className="pt-8 pr-1 flex flex-col">
              ...
              <div id="overview-deck" className="scroll-mt-20">
                <DeckOverviewSection />
              </div>
              ...
              <div
                id="overview-subtype-probability"
